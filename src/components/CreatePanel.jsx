...
//   const panel = await postRef.set(postData)
//   const update = await db.collection("panels").doc(panel.id).set({ id: panel.id }, { merge: true })
//   console.log("what the fuck is happening here?", panel, postRef)
