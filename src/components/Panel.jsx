      ...
      <div id="panel-cont" onContextMenu={e => e.preventDefault()}>
          ...
          <div className={isSnippy}>
            <div className="drawing-buttons" >
                <button className="btn btn-secondary pencilbutton" id="eraser" onClick={this.handleErase}>
                  {this.state.eraserOn? "PENCIL" : "ERASER"}
                </button>

                <h5>pencil sizes:</h5>
                <button className="btn btn-secondary pencilbutton" onClick={this.handlePencil} >thin</button>
                <button className="btn  btn-secondary pencilbutton" onClick={this.handlePencil} >med</button>
                <button className="btn  btn-secondary pencilbutton" onClick={this.handlePencil} >thick</button>

                <div>
                  <button id="submit-button" className="btn btn-lg btn-primary pencilbutton"  onClick={this.handleSubmit}>
                    Submit Panel
                  </button>
                </div>
            </div>
